...
| 0A.2 — Endpoint-eierskap | blocked | `spikes/0a2_endpoint_ownership/`; `tests/spikes/0a2_endpoint_ownership/`; `artifacts/0a2/` | Lokal klassifisering/lock/takeover bestått; to-klient SMB-lab og endelig BLAKE3-marker mangler | Klargjør dedikert SMB-lab og BLAKE3, eller godkjenn scope-reduksjon |
