...
| 0A.5 — Windows argv/pakking | blocked | `spikes/0a5_windows_packaging/`; `tests/spikes/0a5_windows_packaging/`; `artifacts/0a5/` | `GetSystemDirectoryW`/argv bestått; pakkebevis avventer PySide6/Nuitka/Windows SDK/signing tools, låst dependency-sett og ren Windows-VM | Klargjør toolchain/VM før ADR-028 kan anbefales |
