...
| `ADR-003` | Én eller to lokale SQLite-databaser fryses etter Milepæl 0A | `0A.4` | `PROPOSED` |  | `PENDING` |  |  |
...
| `ADR-011` | Catalog/recovery/filsystem koordineres som saga med durable handoffs | `0A.3 + 0A.4` | `PROPOSED` |  | `PENDING` |  |  |
...
| `ADR-018` | Catalog/recovery backup og restore bruker ett manifestert epoch-sett | `0A.4` | `PROPOSED` |  | `PENDING` |  |  |
