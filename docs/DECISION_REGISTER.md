...
| `ADR-028` | Reproduserbar Python/PySide6-pakkestrategi for Windows | `0A.5` | `BLOCKED` | Pakkestrategi kan ikke anbefales før en pakket exe, Windows SDK/signering og ren Windows-VM er tilgjengelig og smoke-testet; minimal PySide6/BLAKE3/Nuitka-runtime er bevist lokalt. | `PENDING` |  |  |
