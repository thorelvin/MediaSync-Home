...
| `ADR-028` | Reproduserbar Python/PySide6-pakkestrategi for Windows | `0A.5` | `BLOCKED` | Pakkestrategi kan ikke anbefales for release før signering/SDK-inventory og ren Windows-VM er tilgjengelig og smoke-testet; minimal PySide6/BLAKE3/Nuitka-runtime og lokal Nuitka standalone exe-smoke er bevist. | `PENDING` |  |  |
