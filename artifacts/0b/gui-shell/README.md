...
detail panel plus activity-bar plan operation, endpoint/snapshot, and source
snapshot-health previews. It does not claim completion of real job creation,
the full GUI workflow, full localization matrix, accessibility review, or final
