...
def test_existing_state_upgrade_resumes_after_only_catalog_migrates(
    ...
    assert _schema_versions(layout) == (58, 13)
    ...
    assert [store.schema_version for store in backup.stores] == [57, 13]
    ...
    assert _schema_versions(layout) == (58, 14)
