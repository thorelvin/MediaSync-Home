...
def test_existing_state_upgrade_resumes_after_only_catalog_migrates(
    ...
    assert _schema_versions(layout) == (44, 10)
    ...
    assert [store.schema_version for store in backup.stores] == [43, 10]
    ...
    assert _schema_versions(layout) == (44, 11)
