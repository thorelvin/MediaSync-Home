...
def test_existing_state_upgrade_resumes_after_only_catalog_migrates(
    ...
    assert _schema_versions(layout) == (36, 7)
    ...
    assert [store.schema_version for store in backup.stores] == [35, 7]
    ...
    assert _schema_versions(layout) == (36, 8)
