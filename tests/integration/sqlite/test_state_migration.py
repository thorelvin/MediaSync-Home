...
def test_existing_state_upgrade_resumes_after_only_catalog_migrates(
    ...
    assert _schema_versions(layout) == (56, 11)
    ...
    assert [store.schema_version for store in backup.stores] == [55, 11]
    ...
    assert _schema_versions(layout) == (56, 12)
