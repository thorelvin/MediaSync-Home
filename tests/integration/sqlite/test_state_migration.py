...
def test_existing_state_upgrade_resumes_after_only_catalog_migrates(
    ...
    assert _schema_versions(layout) == (34, 6)
    ...
    assert [store.schema_version for store in backup.stores] == [33, 6]
    ...
    assert _schema_versions(layout) == (34, 7)
