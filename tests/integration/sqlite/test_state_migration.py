...
def test_existing_state_upgrade_resumes_after_only_catalog_migrates(
    ...
    assert _schema_versions(layout) == (39, 9)
    ...
    assert [store.schema_version for store in backup.stores] == [38, 9]
    ...
    assert _schema_versions(layout) == (39, 10)
