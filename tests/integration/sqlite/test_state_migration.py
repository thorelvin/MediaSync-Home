...
def test_existing_state_upgrade_resumes_after_only_catalog_migrates(
    ...
    assert _schema_versions(layout) == (31, 5)
    ...
    assert [store.schema_version for store in backup.stores] == [30, 5]
    ...
    assert _schema_versions(layout) == (31, 6)
